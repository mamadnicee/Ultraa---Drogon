...
/* =========================
   NEON VAULT STREAM AUTO SCROLL
========================= */
const neonStream = document.querySelector(".neon-vault-stream .scroll-container");
if(neonStream){
  let scrollAmount = 0;
  function scrollLoop() {
    scrollAmount += 0.5; // سرعت اسکرول
    if(scrollAmount >= neonStream.scrollWidth - neonStream.clientWidth) scrollAmount = 0;
    neonStream.scrollLeft = scrollAmount;
